...
-- SELECT * FROM restaurants LIMIT 0,1;

-- INSERT INTO restaurants (rest_name, food_type, website_url, tel_number, rest_description, slot_num)
-- VALUE ("Indian Curry", "Indian", "www.indiancurry.com", "5105555555", "Spicy", 3);

-- INSERT INTO restaurants (rest_name, food_type, website_url, tel_number, rest_description, slot_num)
-- VALUE ("Berkeley Pizza", "Italian", "www.berkeleypizza.com", "574 745 7366", "Best Pizza in Town", 3);
...
-- Plain croissants, chocolate croissants
-- Almond croissants (plain almond, chocolate, raspberry, white chocolate pistachio and seasonal)
-- Biscuit plain
-- Biscuit bakery with provolone cheese and ham or turkey
-- Brioche
-- French baguette
-- Kalamata olive and Herbs de Provence bread loaf
-- Walnut-raisins bread
-- Boule
-- Epis bread
-- Tarts with baked fruits (Apple, pear, apricot, peaches)
